    ...
    <DetailWrapper>
      ...
      <RightContainer>
        ...
        <DonateSection>
          ...
          {cursorss = Data.receivedAmount >= Data.requiredAmount}
          <Donate onClick={DonateFunds} style={{cursor:cursorss ? `not-allowed`: `allowed`, opacity:cursorss? `0.65`:`1`}}>{cursorss ? "Campaign Close": "Donate"}</Donate>
        </DonateSection>
        <FundsData>
          <Funds>
        ...
        {/* {Data.receivedAmount >= Data.requiredAmount ? Donate = `styled.button.visibility` `hidden`: `visible`} */}
        <Donated>
          <LiveDonation>
